...
_COMMANDER_BY_COLOR: dict[str, list[tuple[str, str, str]]] = {
    "W": [
        ...
        ("Teferi's Protection", "Best protection spell in the format", "suggested"),
    ],
    "U": [
        ...
        ("Mystic Remora", "Early card advantage", "suggested"),
    ],
    "B": [
        ...
        ("Vampiric Tutor", "Instant-speed tutor", "suggested"),
    ...
    "R": [
        ...
        ("Jeska's Will", "Explosive mana and card advantage", "suggested"),
    ...
    "G": [
        ...
        ("Sylvan Library", "Card selection engine", "suggested"),
    ],
}
